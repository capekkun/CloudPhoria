...
.asgn-q{background:#fff;border:1px solid #CBD5E1;border-radius:8px;padding:20px;margin-bottom:14px;}
...
.asgn-opt{display:block;padding:10px 14px;background:#F8FAFC;border:1.5px solid #CBD5E1;
